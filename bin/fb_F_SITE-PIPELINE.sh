...
FILTERFILE6=$(echo $FILTERFILE6 | sed 's/vcf/hwe.vcf.gz')
# Subset Individuals
#########################
...
vcftools --vcf $FILTERFILE4 --remove-indels --recode --recode-INFO-all --stdout > consensus.recode.vcf #$FILTERFILE5
# Having trouble... outputs *hwe.recode.vcf
# Does not find file even w/ full written
#perl /home/gbarrett/nf_ArcticGrayling_LandscapeGenomics/bin/filter_hwe_by_pop.pl -v $FILTERFILE5 -p $POPMAP -h 0.001 -c .5 -o consensus
#rm *Kup* *Sag* *Col*
