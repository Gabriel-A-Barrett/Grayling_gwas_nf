...
workflow prepGWAS {
    ...
    meta2grps ( params.meta, vcfListIndividuals.out.vcfIndv, Channel.from(3) ) // get groups for baypass 
    
    vcf2GWAS ( params.vcf, meta2grps.out.grp2bay.collect() ) // subset vcf file and write baypass format
